...
use Prado\Rackspace\DNS\Exception\ServiceUnavailableFault;
use Prado\Rackspace\DNS\Exception\CloudDnsFault;
use Prado\Rackspace\DNS\Exception\CloudDnsException;

/**
 * ServiceUnavailableFault test case.
 */
class ServiceUnavailableFaultTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var Prado\Rackspace\DNS\Exception\ServiceUnavailableFault
     */
    private $fault;
    ...
    {
        $this->fault = new ServiceUnavailableFault;
    }
