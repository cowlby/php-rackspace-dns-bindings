...
use Prado\Rackspace\DNS\Exception\OverLimitFault;
use Prado\Rackspace\DNS\Exception\CloudDnsFault;
use Prado\Rackspace\DNS\Exception\CloudDnsException;

/**
 * OverLimitFault test case.
 */
class OverLimitFaultTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var Prado\Rackspace\DNS\Exception\OverLimitFault
     */
    private $fault;
